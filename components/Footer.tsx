        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-sm text-white/50 leading-relaxed mb-4">
              Book a free 30-minute strategy call to see how we can automate
              your operations.
            </p>
            <Link
              href="#"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-axe-dark text-sm font-bold rounded-full hover:bg-axe-blue hover:text-white transition-colors duration-200"
            >
              Free Consultation
            </Link>
          </div>
